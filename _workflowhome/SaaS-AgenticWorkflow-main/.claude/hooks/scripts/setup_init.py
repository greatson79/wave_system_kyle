...
REQUIRED_SCRIPTS = [
    ...
    # Phase 1: P1 Hallucination Prevention Scripts (workflow implementation)
    "_workflow_dag.py",
    "sot_manager.py",
    "workflow_router.py",
    ...
    # Smart Router (workflow entry point)
    "smart_router.py",
    # Phase 4: Hook Scripts (workflow implementation)
    "validate_task_completion.py",
    "validate_sot_write.py",
]
