...
| 권장 | `4_구조설계.md` 존재 | D, E 실행 권장 (아웃라인 확보) |
...
### Phase 2: 설교 기반 후속 작업 (4.5단계 직후 자동 병렬 소환)

**4.5단계 제목 확정 + sermon-context.md 생성 즉시** D, E0를 자동으로 백그라운드 소환한다.
5단계 원고 완료를 기다리지 않는다. 소환 패턴: `rules/agent-protocol.md` 패턴 A 참조.

**D. 소그룹 나눔지 소환 (WK-D) — 4.5단계 직후 즉시:**
...
**E0. 디자인스카우트 소환 (WK-E0) — D와 동시, 4.5단계 직후:**
1. `sermon-context.md` 내용을 Read로 로드
