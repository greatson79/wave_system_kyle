...
1. `python3 .claude/skills/research/scripts/youtube_search.py "<주제>" -n <top> -d --json > ~/research-output/last_search.json` 실행
...
1. **검색**: `python3 .claude/skills/research/scripts/youtube_search.py "<주제>" -n <top> -d --json` 실행 → 상위 `top`개 URL 추출
