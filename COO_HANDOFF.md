...
1. **주간시대통찰 insight 공개판**
   ...
   - 사적 원본(`output/WaveAI/리서치본부/환경스캐닝/2026-07-03/주간시대통찰_2026-W27_0703_v2.md`) → 공개 각색(내부용어 평문화, 미주 70→65 연속 재정렬)
...
2. **Ministry 사도행전 6:1-7 에세이 「문제가 터졌을 때, 진짜 리더는 규제 대신 권한을 넘긴다」**
   ...
   - 정본 폴더: `output/WaveAI/목회사역/주간콘텐츠팀/`(아티클 내부사본·이미지원본·검수기록 4종·SNS캡션 전부 집결. acts6_insta_0703.png도 이 폴더로 이동, blog repo에서는 제거함)

3. **aitoon 컨텍스트엔지니어링 샘플 (크리에이티브)**
   - `output/WaveAI/크리에이티브본부/AI트렌드/aitoon샘플_컨텍스트엔지니어링_0703/` — cover+page1~4 완성, 캡션/해시태그 준비완료
   - **잔여 = 주인님 수동 인스타 업로드만**
