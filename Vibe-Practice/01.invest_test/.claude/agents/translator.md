...
Then score honestly (score what you actually observe — Python will independently verify):
...
> **P6 Python-First**: After you write the translation, the Orchestrator runs `pacs_calculator.py`
> to independently compute Ft/Ct/Nt from the actual text. Python's score is authoritative.
> Your self-scored Ft/Ct/Nt serve as the pre-mortem self-audit; inflated scores will be detected
> (PA8 WARN if delta > 15, PA8 FAIL if Python pACS RED).
