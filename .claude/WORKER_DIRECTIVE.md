...
- ★★**2026-08-06 주인님 개정**: 아래 티어는 **권장 기본값**이다 — 본부장은 엔진+모델을 상황에
  맞게 **자유 선택**한다(agy는 본부장 배제=워커·리뷰어만). 정본 = MASTER §7 2026-08-06 개정항.
- **★엔진×역할 모델 티어 (2026-07-18 주인님 구체화 · ★2026-08-06 개정으로 권장 기본값 격하)**:
